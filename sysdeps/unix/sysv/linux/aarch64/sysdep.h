...
# ifdef __ASSEMBLER__
#  define PTR_MANGLE(dst, src, guard, guard32, tmp, tmp32)                         \
  LDST_PCREL (ldr, guard, guard32, tmp, C_SYMBOL_NAME(__pointer_chk_guard_local)); \
  PTR_MANGLE2 (dst, src, guard)
/* Use PTR_MANGLE2 for efficiency if guard is already loaded.  */
#  define PTR_MANGLE2(dst, src, guard)\
  eor dst, src, guard
#  define PTR_DEMANGLE(dst, src, guard, guard32, tmp, tmp32)\
  PTR_MANGLE(dst, src, guard, guard32, tmp, tmp32)
...
# ifdef __ASSEMBLER__
#  define PTR_MANGLE(dst, src, guard, guard32, tmp, tmp32)                   \
  LDST_GLOBAL (ldr, guard, tmp, tmp32, C_SYMBOL_NAME(__pointer_chk_guard));  \
  PTR_MANGLE2 (dst, src, guard)
/* Use PTR_MANGLE2 for efficiency if guard is already loaded.  */
#  define PTR_MANGLE2(dst, src, guard)\
  eor dst, src, guard
